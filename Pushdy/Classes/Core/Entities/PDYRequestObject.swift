...
//        throw error
    ...
    func defaultParams() -> [String:Any] {
        var params = [
            ...
            /**
             Need to fallback to getDeviceId that was set by setDeviceId first.
             then if it was not set, fallback to deviceId was generated by PushdySDK
             */
            PDYParam.DeviceID : self.deviceID ?? Pushdy.getDeviceID(),
        ]
